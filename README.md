...
[![Strapi Version](https://img.shields.io/badge/strapi-v3.0.0--alpha.22-blue.svg)](https://github.com/strapi/strapi) 
[![CAPIv2 Version](https://img.shields.io/badge/capiv2-v2.0.21-orange.svg)](https://api.canonn.tech:2083) 
...
The current version of the CAPIv2 is `v2.0.21` and is still in active development and testing. If you would like to contribute please PM DMehaffy on discord `DMehaffy#1337`
