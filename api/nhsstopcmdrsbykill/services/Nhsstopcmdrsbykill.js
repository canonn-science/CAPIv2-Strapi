...
module.exports = {
  ...
  fetchAll: (params) => {
    // Get model hook
    const hook = strapi.hook[Nhsstopcmdrsbykill.orm];
    ...
    return Nhsstopcmdrsbykill.query(function(qb) {
      ...
      hook.load().generateMatchStage(qb)(Nhsstopcmdrsbykill, filters);
  ...
  edit: async (params, values) => {
    ...
    // Create entry with no-relational data.
    const entry = Nhsstopcmdrsbykill.forge(params).save(data);
