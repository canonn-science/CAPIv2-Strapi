...
module.exports = {
  ...
  fetchAll: (params) => {
    // Get model hook
    const hook = strapi.hook[Factionkillreport.orm];
    ...
    return Factionkillreport.query(function(qb) {
      ...
      hook.load().generateMatchStage(qb)(Factionkillreport, filters);
  ...
  edit: async (params, values) => {
    ...
    // Create entry with no-relational data.
    const entry = Factionkillreport.forge(params).save(data);
