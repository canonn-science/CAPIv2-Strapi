...
module.exports = {
  ...
  /**
   * Add relation to a/an csreport record.
   *
   * @return {Object}
   */

  createRelation: async (ctx, next) => {
    return strapi.services.csreport.addRelation(ctx.params, ctx.request.body);
  },

  /**
   * Update relation to a/an csreport record.
   *
   * @return {Object}
   */

  updateRelation: async (ctx, next) => {
    return strapi.services.csreport.editRelation(ctx.params, ctx.request.body);
  },

  /**
   * Destroy relation to a/an csreport record.
   *
   * @return {Object}
   */

  destroyRelation: async (ctx, next) => {
    return strapi.services.csreport.removeRelation(ctx.params, ctx.request.body);
  }
};
