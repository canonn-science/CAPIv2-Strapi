...
module.exports = {
  ...
  /**
   * Add relation to a/an hdsite record.
   *
   * @return {Object}
   */

  createRelation: async (ctx, next) => {
    return strapi.services.hdsite.addRelation(ctx.params, ctx.request.body);
  },

  /**
   * Update relation to a/an hdsite record.
   *
   * @return {Object}
   */

  updateRelation: async (ctx, next) => {
    return strapi.services.hdsite.editRelation(ctx.params, ctx.request.body);
  },

  /**
   * Destroy relation to a/an hdsite record.
   *
   * @return {Object}
   */

  destroyRelation: async (ctx, next) => {
    return strapi.services.hdsite.removeRelation(ctx.params, ctx.request.body);
  }
};
