...
module.exports = {
  ...
  /**
   * Add relation to a/an hdreport record.
   *
   * @return {Object}
   */

  createRelation: async (ctx, next) => {
    return strapi.services.hdreport.addRelation(ctx.params, ctx.request.body);
  },

  /**
   * Update relation to a/an hdreport record.
   *
   * @return {Object}
   */

  updateRelation: async (ctx, next) => {
    return strapi.services.hdreport.editRelation(ctx.params, ctx.request.body);
  },

  /**
   * Destroy relation to a/an hdreport record.
   *
   * @return {Object}
   */

  destroyRelation: async (ctx, next) => {
    return strapi.services.hdreport.removeRelation(ctx.params, ctx.request.body);
  }
};
